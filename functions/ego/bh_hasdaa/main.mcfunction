...
scoreboard players set @a[m=2,score_gDE_min=1,score_gDE=1,score_BHHDpl_min=0,score_BHHDpl=2] BHHDpl 0
scoreboard players add @a BHHDpl 0
execute @a[score_gSA_min=1,score_gSA=1,m=2,score_BHHDpl_min=0,score_BHHDpl=0] ~ ~ ~ function ego:bh_hasdaa/reset_player
execute @a[m=2,score_gLG_min=1,score_gLG=1,score_BHHDpl_min=1,score_BHHDpl=2] ~ ~ ~ function ego:bh_hasdaa/reset_player
execute @e[type=armor_stand,tag=BHHDStand,score_BHHDst_min=0,score_BHHDst=0] ~ ~ ~ function ego:bh_hasdaa/wait_for_start
...
execute @a[x=-1120,y=28,z=-60,dx=73,dy=-4,dz=49,m=2,score_BHHDpl_min=1,score_BHHDpl=2] ~ ~ ~ function ego:bh_hasdaa/teleport_players
