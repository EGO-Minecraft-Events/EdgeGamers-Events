...
scoreboard objectives add BHHDcvr dummy HASDaa Count Seekers
...
scoreboard teams option BHHDh deathMessageVisibility always
scoreboard teams option BHHDh color green
scoreboard teams option BHHDh nametagVisibility never
scoreboard teams option BHHDh seeFriendlyInvisibles false
scoreboard teams add BHHDv HASDaa Seekers
scoreboard teams option BHHDv friendlyfire false
scoreboard teams option BHHDv collisionRule never
scoreboard teams option BHHDv deathMessageVisibility always
...
scoreboard players set &Countdown BHHDcalc 1200
scoreboard players set &Glowing BHHDcalc 6000
scoreboard players set &GameTime BHHDcalc 12000
