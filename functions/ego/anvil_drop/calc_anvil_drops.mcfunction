...
scoreboard players set @s[score_ADcl_min=0,score_ADcl=0] ADcl -1
...
scoreboard players set @s[score_ADcl_min=0,score_ADcl=0] ADcl -1
scoreboard players operation @s[score_ADcl_min=1] ADcl -= @s ADti2
...
scoreboard players set @s[score_ADcl_min=0,score_ADcl=0] ADcl -1
scoreboard players operation @s[score_ADcl_min=1] ADcl -= @s ADti3
