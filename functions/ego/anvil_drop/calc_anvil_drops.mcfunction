...
scoreboard players set @s[score_ADcl_min=0,score_ADcl=0] ADti1 -1
...
scoreboard players set @s[score_ADcl_min=0,score_ADcl=0] ADti2 -1
...
scoreboard players set @s[score_ADcl_min=0,score_ADcl=0] ADti3 -1
