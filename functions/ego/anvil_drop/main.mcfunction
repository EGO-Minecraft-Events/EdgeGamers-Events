...
effect @a[score_gSA_min=1,score_gSA=1,m=2,score_ADpl_min=1,score_ADpl=1,score_gHP=19] minecraft:instant_health 1 100 true
execute @a[score_gDE_min=1,score_gDE=1,score_ADpl_min=2,score_ADpl=2,m=2] ~ ~ ~ function ego:anvil_drop/reset_player
execute @a[x=-19,y=4,z=85,dx=7,dy=5,dz=4,score_ADpl_min=2,score_ADpl=2,m=2] ~ ~ ~ function ego:anvil_drop/reset_player
...
execute @e[type=armor_stand,tag=ADStand,score_ADpe1_min=0,score_ADpe1=100] ~ ~ ~ function ego:anvil_drop/change_percent_1
execute @e[type=armor_stand,tag=ADStand,score_ADpe2_min=0,score_ADpe2=100] ~ ~ ~ function ego:anvil_drop/change_percent_2
execute @e[type=armor_stand,tag=ADStand,score_ADpe3_min=0,score_ADpe3=100] ~ ~ ~ function ego:anvil_drop/toggle_walls
...
effect @a[score_gSA_min=1,score_gSA=1,m=2,score_ADpl_min=2,score_ADpl=2] minecraft:jump_boost 2 250 true
