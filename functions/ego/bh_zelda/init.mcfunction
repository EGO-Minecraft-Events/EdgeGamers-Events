...
scoreboard objectives add BHZcvr dummy Zelda Count Seekers
...
scoreboard teams option BHZh deathMessageVisibility always
scoreboard teams option BHZh color green
scoreboard teams option BHZh nametagVisibility never
scoreboard teams option BHZh seeFriendlyInvisibles false
scoreboard teams add BHZv Zelda Seekers
scoreboard teams option BHZv friendlyfire false
scoreboard teams option BHZv collisionRule never
scoreboard teams option BHZv deathMessageVisibility always
...
scoreboard players set &Countdown BHZcalc 1200
scoreboard players set &Glowing BHZcalc 6000
scoreboard players set &GameTime BHZcalc 12000
