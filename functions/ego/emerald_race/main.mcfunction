...
effect @a[x=219,y=5,z=-121,dx=75,dy=100,dz=51,m=2,score_ERde_min=1] clear
clear @a[x=219,y=5,z=-121,dx=75,dy=100,dz=51,m=2,score_ERde_min=1]
scoreboard players set @a[x=219,y=5,z=-121,dx=75,dy=100,dz=51,m=2,score_ERde_min=1] FLbk 704022040
