...
scoreboard players set @e[x=46,y=4,z=47,dx=7,dy=5,dz=12,type=area_effect_cloud] MMrn 7
scoreboard players add @e[score_MMrn_min=7,score_MMrn=7,tag=MMGuess] MMbi 0
execute @e[score_MMrn_min=7,score_MMrn=7,tag=MMGuess] ~ ~ ~ detect ~ ~-1 ~ wool 14 scoreboard players set @s MMbi 1
execute @e[score_MMrn_min=7,score_MMrn=7,tag=MMGuess] ~ ~ ~ detect ~ ~-1 ~ wool 5 scoreboard players set @s MMbi 2
execute @e[score_MMrn_min=7,score_MMrn=7,tag=MMGuess] ~ ~ ~ detect ~ ~-1 ~ wool 9 scoreboard players set @s MMbi 3
execute @e[score_MMrn_min=7,score_MMrn=7,tag=MMGuess] ~ ~ ~ detect ~ ~-1 ~ wool 2 scoreboard players set @s MMbi 4
execute @e[score_MMrn_min=7,score_MMrn=7,tag=MMGuess] ~ ~ ~ detect ~ ~-1 ~ wool 6 scoreboard players set @s MMbi 5
execute @e[score_MMrn_min=7,score_MMrn=7,tag=MMGuess] ~ ~ ~ detect ~ ~-1 ~ wool 1 scoreboard players set @s MMbi 6
execute @e[score_MMrn_min=7,score_MMrn=7,tag=MMGuess,score_MMbi_min=1,score_MMbi=1] ~ ~ ~ scoreboard players add @e[score_MMrn_min=7,score_MMrn=7,tag=MMRepeat1] MMcl 1
execute @e[score_MMrn_min=7,score_MMrn=7,tag=MMGuess,score_MMbi_min=2,score_MMbi=2] ~ ~ ~ scoreboard players add @e[score_MMrn_min=7,score_MMrn=7,tag=MMRepeat2] MMcl 1
execute @e[score_MMrn_min=7,score_MMrn=7,tag=MMGuess,score_MMbi_min=3,score_MMbi=3] ~ ~ ~ scoreboard players add @e[score_MMrn_min=7,score_MMrn=7,tag=MMRepeat3] MMcl 1
execute @e[score_MMrn_min=7,score_MMrn=7,tag=MMGuess,score_MMbi_min=4,score_MMbi=4] ~ ~ ~ scoreboard players add @e[score_MMrn_min=7,score_MMrn=7,tag=MMRepeat4] MMcl 1
execute @e[score_MMrn_min=7,score_MMrn=7,tag=MMGuess,score_MMbi_min=5,score_MMbi=5] ~ ~ ~ scoreboard players add @e[score_MMrn_min=7,score_MMrn=7,tag=MMRepeat5] MMcl 1
execute @e[score_MMrn_min=7,score_MMrn=7,tag=MMGuess,score_MMbi_min=6,score_MMbi=6] ~ ~ ~ scoreboard players add @e[score_MMrn_min=7,score_MMrn=7,tag=MMRepeat6] MMcl 1
scoreboard players add @s MMra 0
execute @e[score_MMrn_min=7,score_MMrn=7,tag=MMRepeat,score_MMcl_min=2] ~ ~ ~ scoreboard players set @a[score_MMrn_min=7,score_MMrn=7,score_MMcl_min=1,score_MMcl=1] MMra 1
