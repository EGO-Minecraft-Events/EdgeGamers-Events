...
execute @s[score_MMcl_min=1,score_MMcl=1] ~ ~ ~ function ego:mastermind/select_player_for_guess_11
...
scoreboard players operation @a[score_MMrn_min=11,score_MMrn=11] MMec = @s MMpl
