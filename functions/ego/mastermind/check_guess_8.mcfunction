...
execute @s[score_MMcl_min=1,score_MMcl=1] ~ ~ ~ function ego:mastermind/select_player_for_guess_8
...
scoreboard players operation @a[score_MMrn_min=8,score_MMrn=8] MMec = @s MMpl
