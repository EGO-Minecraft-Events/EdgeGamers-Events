...
execute @s[score_MMcl_min=1,score_MMcl=1] ~ ~ ~ function ego:mastermind/select_player_for_guess_9
...
scoreboard players operation @a[score_MMrn_min=9,score_MMrn=9] MMec = @s MMpl
