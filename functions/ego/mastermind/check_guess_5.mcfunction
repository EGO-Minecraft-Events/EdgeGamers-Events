...
execute @s[score_MMcl_min=1,score_MMcl=1] ~ ~ ~ function ego:mastermind/select_player_for_guess_5
...
scoreboard players operation @a[score_MMrn_min=5,score_MMrn=5] MMec = @s MMpl
