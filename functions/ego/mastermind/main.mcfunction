...
scoreboard players add @a[score_gSA_min=1,score_gSA=1,m=2] MMpl 0
execute @a[score_gSA_min=1,score_gSA=1,score_MMpl_min=0,score_MMpl=0,m=2] ~ ~ ~ function ego:mastermind/reset_player
...
scoreboard players set @a[x=46,y=5,z=38,dx=62,dy=5,dz=7,m=2] MM 0
scoreboard players set @a[x=46,y=5,z=38,dx=62,dy=5,dz=7,m=1] MM 0
...
scoreboard players reset @a[score_gSA_min=1,score_gSA=1,m=3] MMrn
scoreboard players reset @a[score_gSA_min=1,score_gSA=1,m=3] MM
