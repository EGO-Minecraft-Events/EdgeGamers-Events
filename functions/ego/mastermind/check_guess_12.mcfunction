...
execute @s[score_MMcl_min=1,score_MMcl=1] ~ ~ ~ function ego:mastermind/select_player_for_guess_12
...
scoreboard players operation @a[score_MMrn_min=12,score_MMrn=12] MMec = @s MMpl
