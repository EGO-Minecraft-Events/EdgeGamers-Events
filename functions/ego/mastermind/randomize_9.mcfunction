...
scoreboard players operation @e[score_MMrn_min=9,score_MMrn=9,type=armor_stand,tag=MMCorrect1] MMca = @e[type=area_effect_cloud,tag=MMRandom,score_MMcl_min=0,score_MMcl=0] MMca
kill @e[type=area_effect_cloud,score_MMcl_min=0,score_MMcl=0]
scoreboard players add @r[type=area_effect_cloud,tag=MMRandom] MMcl 0
scoreboard players operation @e[score_MMrn_min=9,score_MMrn=9,type=armor_stand,tag=MMCorrect2] MMca = @e[type=area_effect_cloud,tag=MMRandom,score_MMcl_min=0,score_MMcl=0] MMca
kill @e[type=area_effect_cloud,score_MMcl_min=0,score_MMcl=0]
scoreboard players add @r[type=area_effect_cloud,tag=MMRandom] MMcl 0
scoreboard players operation @e[score_MMrn_min=9,score_MMrn=9,type=armor_stand,tag=MMCorrect3] MMca = @e[type=area_effect_cloud,tag=MMRandom,score_MMcl_min=0,score_MMcl=0] MMca
kill @e[type=area_effect_cloud,score_MMcl_min=0,score_MMcl=0]
scoreboard players add @r[type=area_effect_cloud,tag=MMRandom] MMcl 0
scoreboard players operation @e[score_MMrn_min=9,score_MMrn=9,type=armor_stand,tag=MMCorrect4] MMca = @e[type=area_effect_cloud,tag=MMRandom,score_MMcl_min=0,score_MMcl=0] MMca
