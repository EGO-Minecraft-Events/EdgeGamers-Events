...
execute @e[score_MMrn_min=6,score_MMrn=6,tag=MMRepeat,score_MMcl_min=2] ~ ~ ~ scoreboard players set @a[c=1,r=1,score_MMcl_min=1,score_MMcl=1] MMra 1
...
execute @e[tag=MMGuess,score_MMbi_min=0,score_MMbi=0] ~ ~ ~ say WTF @a[score_MMrn_min=6,score_MMrn=6,score_MMcl_min=1,score_MMcl=1] WTF
