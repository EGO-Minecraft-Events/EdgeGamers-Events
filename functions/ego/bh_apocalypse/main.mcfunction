...
scoreboard players set @a[m=2,score_gDE_min=1,score_gDE=1,score_BHApl_min=0,score_BHApl=2] BHApl 0
scoreboard players add @a BHApl 0
execute @a[score_gSA_min=1,score_gSA=1,m=2,score_BHApl_min=0,score_BHApl=0] ~ ~ ~ function ego:bh_apocalypse/reset_player
execute @a[m=2,score_gLG_min=1,score_gLG=1,score_BHApl_min=1,score_BHApl=2] ~ ~ ~ function ego:bh_apocalypse/reset_player
execute @e[type=armor_stand,tag=BHAStand,score_BHAst_min=0,score_BHAst=0] ~ ~ ~ function ego:bh_apocalypse/wait_for_start
...
execute @a[x=-1565,y=47,z=-102,dx=74,dy=-3,dz=94,m=2,score_BHApl_min=1,score_BHApl=2] ~ ~ ~ function ego:bh_apocalypse/teleport_players
