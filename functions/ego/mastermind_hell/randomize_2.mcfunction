...
scoreboard players operation @e[score_MMHrn_min=2,score_MMHrn=2,type=armor_stand,tag=MMHCorrect1] MMHca = @e[type=area_effect_cloud,tag=MMHRandom,score_MMHcl_min=0,score_MMHcl=0] MMHca
kill @e[type=area_effect_cloud,score_MMHcl_min=0,score_MMHcl=0]
scoreboard players add @r[type=area_effect_cloud,tag=MMHRandom] MMHcl 0
scoreboard players operation @e[score_MMHrn_min=2,score_MMHrn=2,type=armor_stand,tag=MMHCorrect2] MMHca = @e[type=area_effect_cloud,tag=MMHRandom,score_MMHcl_min=0,score_MMHcl=0] MMHca
kill @e[type=area_effect_cloud,score_MMHcl_min=0,score_MMHcl=0]
scoreboard players add @r[type=area_effect_cloud,tag=MMHRandom] MMHcl 0
scoreboard players operation @e[score_MMHrn_min=2,score_MMHrn=2,type=armor_stand,tag=MMHCorrect3] MMHca = @e[type=area_effect_cloud,tag=MMHRandom,score_MMHcl_min=0,score_MMHcl=0] MMHca
kill @e[type=area_effect_cloud,score_MMHcl_min=0,score_MMHcl=0]
scoreboard players add @r[type=area_effect_cloud,tag=MMHRandom] MMHcl 0
scoreboard players operation @e[score_MMHrn_min=2,score_MMHrn=2,type=armor_stand,tag=MMHCorrect4] MMHca = @e[type=area_effect_cloud,tag=MMHRandom,score_MMHcl_min=0,score_MMHcl=0] MMHca
kill @e[type=area_effect_cloud,score_MMHcl_min=0,score_MMHcl=0]
scoreboard players add @r[type=area_effect_cloud,tag=MMHRandom] MMHcl 0
scoreboard players operation @e[score_MMHrn_min=2,score_MMHrn=2,type=armor_stand,tag=MMHCorrect5] MMHca = @e[type=area_effect_cloud,tag=MMHRandom,score_MMHcl_min=0,score_MMHcl=0] MMHca
kill @e[type=area_effect_cloud,score_MMHcl_min=0,score_MMHcl=0]
scoreboard players add @r[type=area_effect_cloud,tag=MMHRandom] MMHcl 0
scoreboard players operation @e[score_MMHrn_min=2,score_MMHrn=2,type=armor_stand,tag=MMHCorrect6] MMHca = @e[type=area_effect_cloud,tag=MMHRandom,score_MMHcl_min=0,score_MMHcl=0] MMHca
