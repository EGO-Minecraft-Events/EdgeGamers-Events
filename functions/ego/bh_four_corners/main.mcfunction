...
scoreboard players set @a[score_gSA_min=1,score_gSA=1,score_FLid=-1988608738] FLid 1988608737
scoreboard players set @a[score_gSA_min=1,score_gSA=1,score_FLid_min=-1988608736] FLid 1988608737
kill @e[x=-1358,y=111,z=-190,dx=90,dy=-107,dz=-90,tag=!BHFCEntity,type=item]
scoreboard players set @a[m=2,score_gDE_min=1,score_gDE=1,score_BHFCpl_min=1,score_BHFCpl=1] BHFCpl 0
execute @a[m=2,score_gLG_min=1,score_gLG=1,score_BHFCpl_min=1,score_BHFCpl=1] ~ ~ ~ function ego:bh_four_corners/assign_teams
...
execute @a[score_gSA_min=1,score_gSA=1,m=2,score_BHFCpl_min=0,score_BHFCpl=0] ~ ~ ~ function ego:bh_four_corners/assign_teams
execute @a[m=2,score_BHFCpl_min=1,score_BHFCpl=1] ~ ~ ~ function ego:bh_four_corners/teleport_players
