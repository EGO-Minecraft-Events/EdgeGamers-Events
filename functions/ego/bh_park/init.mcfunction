...
scoreboard objectives add BHPcvr dummy Park Count Seekers
...
scoreboard teams option BHPh deathMessageVisibility always
scoreboard teams option BHPh color green
scoreboard teams option BHPh nametagVisibility never
scoreboard teams option BHPh seeFriendlyInvisibles false
scoreboard teams add BHPv Park Seekers
scoreboard teams option BHPv friendlyfire false
scoreboard teams option BHPv collisionRule never
scoreboard teams option BHPv deathMessageVisibility always
...
scoreboard players set &Countdown BHPcalc 1200
scoreboard players set &Glowing BHPcalc 6000
scoreboard players set &GameTime BHPcalc 12000
