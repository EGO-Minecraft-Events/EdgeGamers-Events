...
scoreboard players set @e[type=armor_stand,tag=FlooStand] FLtp 1561350379
...
scoreboard teams option VR2h deathMessageVisibility never
...
scoreboard teams option VR2v deathMessageVisibility never
...
scoreboard players set @e[type=armor_stand,tag=FlooStand,score_FLgam_min=0,score_FLgam=0] FLgam 1561350379
