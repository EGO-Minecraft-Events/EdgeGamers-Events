scoreboard players operation @s BHASVcalc = BHASVGlowing BHASVcalc
scoreboard players operation @s BHASVcalc -= @s BHASVti
execute @s[score_BHASVcalc_min=0,score_BHASVcalc=0] ~ ~ ~ tellraw @a {"text":"","extra":[{"text":"[","color":"gray"},{"text":"BHASV","color":"green","bold":"true","hoverEvent":{"action":"show_text","value":{"text":"A Small Village","color":"green"}},"clickEvent":{"action":"run_command","value":"/scoreboard players set @p FLtp 1027889765"}},{"text":"]","color":"gray"},{"text":": "},{"text":"Glowing has been removed from all seekers!","color":"yellow"}]}
