function ego:bh_a_small_village/reset_player
function ego:bh_a_small_village/to_hider if @e[type=armor_stand,tag=BHASVStand,score_BHASVst_min=0,score_BHASVst=2]
