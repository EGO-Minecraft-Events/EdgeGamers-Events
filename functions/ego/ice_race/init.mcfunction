...
scoreboard objectives add IRcl dummy Ice race Clear
scoreboard objectives add IRde deathCount Ice race Deaths
...
summon area_effect_cloud ~ ~ ~ {Duration:130,Tags:["IRcountdown"]}
