function ego:bh_castle_de_emmy/reset_player
function ego:bh_castle_de_emmy/to_hider if @e[type=armor_stand,tag=BHCDEStand,score_BHCDEst_min=0,score_BHCDEst=2]
