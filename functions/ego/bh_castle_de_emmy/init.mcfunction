...
scoreboard objectives add BHCDEcvr dummy Castle de Emmy Count Seekers
...
scoreboard teams option BHCDEh deathMessageVisibility always
scoreboard teams option BHCDEh color green
scoreboard teams option BHCDEh nametagVisibility never
scoreboard teams option BHCDEh seeFriendlyInvisibles false
scoreboard teams add BHCDEv Castle de Emmy Seekers
scoreboard teams option BHCDEv friendlyfire false
scoreboard teams option BHCDEv collisionRule never
scoreboard teams option BHCDEv deathMessageVisibility always
...
scoreboard players set &Countdown BHCDEcalc 1200
scoreboard players set &Glowing BHCDEcalc 6000
scoreboard players set &GameTime BHCDEcalc 12000
