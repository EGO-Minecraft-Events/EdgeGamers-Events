...
scoreboard players set @e[type=armor_stand,tag=FlooStand,score_FLgam_min=1498681551,score_FLgam=1498681551] FLgam 0
tellraw @a[score_EC_min=0,score_EC=0] {"text":"","extra":[{"text":"[","color":"gray"},{"text":"BHCDE","color":"green","bold":"true","hoverEvent":{"action":"show_text","value":{"text":"Castle de Emmy","color":"green"}},"clickEvent":{"action":"run_command","value":"/scoreboard players set @p FLtp 1498681551"}},{"text":"]","color":"gray"},{"text":": "},{"text":"Castle de Emmy","color":"green","bold":"true","hoverEvent":{"action":"show_text","value":{"text":"Castle de Emmy","color":"green"}},"clickEvent":{"action":"run_command","value":"/scoreboard players set @p FLtp 1498681551"}},{"text":" has stopped!","color":"red"}]}
