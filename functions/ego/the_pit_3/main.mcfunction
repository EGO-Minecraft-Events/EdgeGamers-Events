...
scoreboard players set @e[type=arrow] TPcl 1 {inGround:1b}
...
execute @e[type=armor_stand,tag=TPStand,score_TPst_min=2,score_TPst=3] ~ ~ ~ function ego:the_pit_3/display
