...
summon area_effect_cloud ~ ~0.02 ~ {Duration:2147483647,CustomName:"banana",Tags:["PCEntity","PCTopic"]}
summon area_effect_cloud ~ ~0.03 ~ {Duration:2147483647,CustomName:"corgi",Tags:["PCEntity","PCTopic"]}
...
tellraw @a {"text":"","extra":[{"text":"[","color":"gray"},{"text":"PC","color":"dark_aqua","bold":"true","hoverEvent":{"action":"show_text","value":{"text":"Pictionary","color":"dark_aqua"}},"clickEvent":{"action":"run_command","value":"/scoreboard players set @p FLtp 1301307747"}},{"text":"]","color":"gray"},{"text":": "},{"text":"Tonight's Theme: ","color":"dark_aqua"},{"text":"theme","color":"gold","bold":"true"}]}
