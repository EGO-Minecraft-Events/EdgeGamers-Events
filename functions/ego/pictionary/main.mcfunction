...
execute @e[type=armor_stand,tag=PCStand,score_PCst_min=3,score_PCst=3] ~ ~ ~ function ego:pictionary/during_round
execute @e[type=armor_stand,tag=PCStand,score_PCst_min=4,score_PCst=4] ~ ~ ~ function ego:pictionary/stop_round
