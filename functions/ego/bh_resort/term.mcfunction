...
scoreboard players set @e[type=armor_stand,tag=FlooStand,score_FLgam_min=1317713609,score_FLgam=1317713609] FLgam 0
tellraw @a[score_EC_min=0,score_EC=0] {"text":"","extra":[{"text":"[","color":"gray"},{"text":"BHRE","color":"green","bold":"true","hoverEvent":{"action":"show_text","value":{"text":"Resort","color":"green"}},"clickEvent":{"action":"run_command","value":"/scoreboard players set @p FLtp 1317713609"}},{"text":"]","color":"gray"},{"text":": "},{"text":"Resort","color":"green","bold":"true","hoverEvent":{"action":"show_text","value":{"text":"Resort","color":"green"}},"clickEvent":{"action":"run_command","value":"/scoreboard players set @p FLtp 1317713609"}},{"text":" has stopped!","color":"red"}]}
execute @a[score_BHREpl_min=1,score_BHREpl=1,m=2] ~ ~ ~ function ego:bh_resort/full_reset_player
