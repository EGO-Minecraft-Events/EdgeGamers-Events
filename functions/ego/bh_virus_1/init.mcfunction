...
scoreboard objectives add BHVR1cvr dummy Virus 1 Count Seekers
...
scoreboard teams option BHVR1h deathMessageVisibility always
scoreboard teams option BHVR1h color green
scoreboard teams option BHVR1h nametagVisibility never
scoreboard teams option BHVR1h seeFriendlyInvisibles false
scoreboard teams add BHVR1v Virus 1 Seekers
scoreboard teams option BHVR1v friendlyfire false
scoreboard teams option BHVR1v collisionRule never
scoreboard teams option BHVR1v deathMessageVisibility always
...
scoreboard players set &Countdown BHVR1calc 1200
scoreboard players set &Glowing BHVR1calc 6000
scoreboard players set &GameTime BHVR1calc 12000
