...
scoreboard players set @e[type=armor_stand,tag=FlooStand] FLtp 1387594773
...
scoreboard objectives add BHVR1 dummy BH Virus 1
scoreboard objectives setdisplay sidebar BHVR1
scoreboard objectives add BHVR1pl dummy BH Virus 1 Player List
scoreboard objectives add BHVR1sa dummy BH Virus 1 Select All
scoreboard objectives add BHVR1ti dummy BH Virus 1 Timer
scoreboard objectives add BHVR1chi dummy BH Virus 1 Count Hiders
scoreboard objectives add BHVR1cvr dummy BH Virus 1 Count Virus
scoreboard objectives add BHVR1gl dummy BH Virus 1 Glowing Players
scoreboard objectives add BHVR1calc dummy BH Virus 1 Calculations
scoreboard objectives add BHVR1st dummy BH Virus 1 State
scoreboard teams add BHVR1h BH Virus 1 Hiders
...
scoreboard teams add BHVR1v BH Virus 1 Virus
...
scoreboard teams add BHVR1d_y BH Virus 1 Display Yellow
scoreboard teams option BHVR1d_y color yellow
scoreboard teams add BHVR1d_g BH Virus 1 Display Green
...
tellraw @a[score_EC_min=0,score_EC=0] {"text":"","extra":[{"text":"[","color":"gray"},{"text":"BHVR1","color":"yellow","bold":"true","hoverEvent":{"action":"show_text","value":{"text":"BH Virus 1","color":"yellow"}},"clickEvent":{"action":"run_command","value":"/scoreboard players set @p FLtp 1387594773"}},{"text":"]","color":"gray"},{"text":": "},{"text":"BH Virus 1","color":"yellow","bold":"true","hoverEvent":{"action":"show_text","value":{"text":"BH Virus 1","color":"yellow"}},"clickEvent":{"action":"run_command","value":"/scoreboard players set @p FLtp 1387594773"}},{"text":" has started!","color":"green"}]}
scoreboard players set @e[type=armor_stand,tag=FlooStand,score_FLgam_min=0,score_FLgam=0] FLgam 1387594773
