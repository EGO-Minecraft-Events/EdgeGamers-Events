...
scoreboard players set @a[m=2,score_gDE_min=1,score_gDE=1,score_VR1pl_min=0,score_VR1pl=2] VR1pl 0
scoreboard players add @a VR1pl 0
execute @a[score_gSA_min=1,score_gSA=1,m=2,score_VR1pl_min=0,score_VR1pl=0] ~ ~ ~ function ego:virus_1/reset_player
execute @a[m=2,score_gLG_min=1,score_gLG=1,score_VR1pl_min=1,score_VR1pl=2] ~ ~ ~ function ego:virus_1/reset_player
execute @e[type=armor_stand,tag=VR1Stand,score_VR1st_min=0,score_VR1st=0] ~ ~ ~ function ego:virus_1/wait_for_start
...
execute @a[x=-85,y=45,z=-241,dx=31,dy=5,dz=31,m=2,score_VR1pl_min=1,score_VR1pl=2] ~ ~ ~ function ego:virus_1/teleport_players
