...
scoreboard players set @e[type=armor_stand,tag=FlooStand] FLtp 658982564
...
scoreboard objectives add BHRAcvr dummy Rainbow Count Seekers
...
scoreboard teams option BHRAh deathMessageVisibility always
scoreboard teams option BHRAh color green
scoreboard teams option BHRAh nametagVisibility never
scoreboard teams option BHRAh seeFriendlyInvisibles false
scoreboard teams add BHRAv Rainbow Seekers
scoreboard teams option BHRAv friendlyfire false
scoreboard teams option BHRAv collisionRule never
scoreboard teams option BHRAv deathMessageVisibility always
...
scoreboard players set &Countdown BHRAcalc 1200
scoreboard players set &Glowing BHRAcalc 6000
scoreboard players set &GameTime BHRAcalc 12000
...
tellraw @a[score_EC_min=0,score_EC=0] {"text":"","extra":[{"text":"[","color":"gray"},{"text":"BHRA","color":"green","bold":"true","hoverEvent":{"action":"show_text","value":{"text":"Rainbow","color":"green"}},"clickEvent":{"action":"run_command","value":"/scoreboard players set @p FLtp 658982564"}},{"text":"]","color":"gray"},{"text":": "},{"text":"Rainbow","color":"green","bold":"true","hoverEvent":{"action":"show_text","value":{"text":"Rainbow","color":"green"}},"clickEvent":{"action":"run_command","value":"/scoreboard players set @p FLtp 658982564"}},{"text":" has started!","color":"green"}]}
scoreboard players set @e[type=armor_stand,tag=FlooStand,score_FLgam_min=0,score_FLgam=0] FLgam 658982564
