...
scoreboard players set @e[type=armor_stand,tag=FlooStand,score_FLgam_min=366421968,score_FLgam=366421968] FLgam 0
tellraw @a[score_EC_min=0,score_EC=0] {"text":"","extra":[{"text":"[","color":"gray"},{"text":"BHRA","color":"green","bold":"true","hoverEvent":{"action":"show_text","value":{"text":"Rainbow","color":"green"}},"clickEvent":{"action":"run_command","value":"/scoreboard players set @p FLtp 366421968"}},{"text":"]","color":"gray"},{"text":": "},{"text":"Rainbow","color":"green","bold":"true","hoverEvent":{"action":"show_text","value":{"text":"Rainbow","color":"green"}},"clickEvent":{"action":"run_command","value":"/scoreboard players set @p FLtp 366421968"}},{"text":" has stopped!","color":"red"}]}
