...
scoreboard players set @a[m=2,score_gDE_min=1,score_gDE=1,score_BHTSpl_min=0,score_BHTSpl=2] BHTSpl 0
scoreboard players add @a BHTSpl 0
execute @a[score_gSA_min=1,score_gSA=1,m=2,score_BHTSpl_min=0,score_BHTSpl=0] ~ ~ ~ function ego:bh_train_station/reset_player
execute @a[m=2,score_gLG_min=1,score_gLG=1,score_BHTSpl_min=1,score_BHTSpl=2] ~ ~ ~ function ego:bh_train_station/reset_player
execute @e[type=armor_stand,tag=BHTSStand,score_BHTSst_min=0,score_BHTSst=0] ~ ~ ~ function ego:bh_train_station/wait_for_start
...
execute @a[x=-1208,y=34,z=-186,dx=-175,dy=-3,dz=175,m=2,score_BHTSpl_min=1,score_BHTSpl=2] ~ ~ ~ function ego:bh_train_station/teleport_players
