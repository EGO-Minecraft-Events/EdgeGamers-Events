...
scoreboard players set @e[type=armor_stand,tag=FlooStand] FLtp 1991689630
...
scoreboard players set @e[type=armor_stand,tag=FlooStand,score_FLgam_min=0,score_FLgam=0] FLgam 1991689630
