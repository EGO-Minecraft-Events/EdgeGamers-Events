function ego:bh_train_station/reset_player
function ego:bh_train_station/to_hider if @e[type=armor_stand,tag=BHTSStand,score_BHTSst_min=0,score_BHTSst=2]
