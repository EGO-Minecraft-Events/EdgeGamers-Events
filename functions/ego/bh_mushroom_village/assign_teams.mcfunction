function ego:bh_mushroom_village/reset_player
function ego:bh_mushroom_village/to_hider if @e[type=armor_stand,tag=BHMVStand,score_BHMVst_min=0,score_BHMVst=2]
