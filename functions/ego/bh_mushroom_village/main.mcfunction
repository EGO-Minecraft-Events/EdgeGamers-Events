...
scoreboard players set @a[m=2,score_gDE_min=1,score_gDE=1,score_BHMVpl_min=0,score_BHMVpl=2] BHMVpl 0
scoreboard players add @a BHMVpl 0
execute @a[score_gSA_min=1,score_gSA=1,m=2,score_BHMVpl_min=0,score_BHMVpl=0] ~ ~ ~ function ego:bh_mushroom_village/reset_player
execute @a[m=2,score_gLG_min=1,score_gLG=1,score_BHMVpl_min=1,score_BHMVpl=2] ~ ~ ~ function ego:bh_mushroom_village/reset_player
execute @e[type=armor_stand,tag=BHMVStand,score_BHMVst_min=0,score_BHMVst=0] ~ ~ ~ function ego:bh_mushroom_village/wait_for_start
...
execute @a[x=-117,y=48,z=-225,dx=-929,dy=-5,dz=72,m=2,score_BHMVpl_min=1,score_BHMVpl=2] ~ ~ ~ function ego:bh_mushroom_village/teleport_players
