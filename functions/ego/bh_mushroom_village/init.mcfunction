...
scoreboard objectives add BHMVcvr dummy Mushroom Village Count Virus
...
scoreboard players set BHMVCountdown BHMVcalc 1200
scoreboard players set BHMVGlowing BHMVcalc 6000
