...
scoreboard objectives add BHOcvr dummy Old Count Seekers
...
scoreboard teams option BHOh deathMessageVisibility always
scoreboard teams option BHOh color green
scoreboard teams option BHOh nametagVisibility never
scoreboard teams option BHOh seeFriendlyInvisibles false
scoreboard teams add BHOv Old Seekers
scoreboard teams option BHOv friendlyfire false
scoreboard teams option BHOv collisionRule never
scoreboard teams option BHOv deathMessageVisibility always
...
scoreboard players set &Countdown BHOcalc 1200
scoreboard players set &Glowing BHOcalc 6000
scoreboard players set &GameTime BHOcalc 12000
