scoreboard players operation @s BHOcalc = &Glowing BHOcalc
scoreboard players operation @s BHOcalc -= @s BHOti
execute @s[score_BHOcalc_min=0,score_BHOcalc=0] ~ ~ ~ tellraw @a {"text":"","extra":[{"text":"[","color":"gray"},{"text":"BHO","color":"green","bold":"true","hoverEvent":{"action":"show_text","value":{"text":"Old","color":"green"}},"clickEvent":{"action":"run_command","value":"/scoreboard players set @p FLtp 354536009"}},{"text":"]","color":"gray"},{"text":": "},{"text":"Glowing has been removed from all seekers!","color":"yellow"}]}
