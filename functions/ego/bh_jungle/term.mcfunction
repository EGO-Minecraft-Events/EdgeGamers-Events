...
scoreboard players set @e[type=armor_stand,tag=FlooStand,score_FLgam_min=1023416591,score_FLgam=1023416591] FLgam 0
tellraw @a[score_EC_min=0,score_EC=0] {"text":"","extra":[{"text":"[","color":"gray"},{"text":"BHJ","color":"green","bold":"true","hoverEvent":{"action":"show_text","value":{"text":"Jungle","color":"green"}},"clickEvent":{"action":"run_command","value":"/scoreboard players set @p FLtp 1023416591"}},{"text":"]","color":"gray"},{"text":": "},{"text":"Jungle","color":"green","bold":"true","hoverEvent":{"action":"show_text","value":{"text":"Jungle","color":"green"}},"clickEvent":{"action":"run_command","value":"/scoreboard players set @p FLtp 1023416591"}},{"text":" has stopped!","color":"red"}]}
execute @a[score_BHJpl_min=1,score_BHJpl=1,m=2] ~ ~ ~ function ego:bh_jungle/full_reset_player
